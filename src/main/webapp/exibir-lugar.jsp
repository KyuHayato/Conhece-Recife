		...
		<div class="row" style="margin-top: 75px;">
			<div class="col-sm-6">
				...
				<article class="post_1"
					style="align-items: center; text-align: justify;">
					<p>
			...
			<div class="col-sm-6">
				<aside style="margin-left: 20px;">
					<div style="align-items: center; text-align: center;">
						...
						<h2 id="Titulo2"
							style='position: absolute; top: 0px; letter-spacing: -0.15em; font-family: Fjalla One; text-transform: uppercase; left: 10%; font-size: 75px; color: rgba(0, 0, 0, 0.08);'>
							<%=place.getName()%></h2>
					</div>
					...
					<div
						...
						<h7>Endere&ccedilo: Rua <%=place.getRoad()%>, <%=place.getNumber()%>,
						<%=place.getDistrict()%>, <%=place.getCity()%></h7>
			...
			<footer>
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<h6 style="color: red;">SUBWAY - CLONE DE SUGESTAO DO DIA -
							5% DE DESCONTO</h6>
					</div>
