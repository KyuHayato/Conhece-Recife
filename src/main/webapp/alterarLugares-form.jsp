...
%>
	...
	<section>
		<div class="container">
				...
				<div class="col-lg-12">
					<div class="mb-4">
						<h1 class="text-center label-disabled"
							style="font-family: Fjalla One;">ALTERAR LUGARES</h1>
						<h1 class="text-center" style="font-family: Fjalla One;">ALTERAR LUGARES</h1>
					</div>
				</div>
			</div>
			<div>
			...
			<form class="form" action="controller/controllerPlaceUpdate.jsp">
									...
									<div class="form-group">
										...
										<div>
											<span class="style-error" id="errorCepPlace"
												...
												numeros deve ser 8 ou não são numeros</span>
										</div>
									</div>
								</div>
								<div class="col">
									...
									<div class="form-group">
										...
										<div>
											<span class="style-error" id="errorDescriptionPlace"
												style="display: none;">Descrição invalida, insira os
												dados de forma correta</span>
										</div>
									</div>
								</div>
