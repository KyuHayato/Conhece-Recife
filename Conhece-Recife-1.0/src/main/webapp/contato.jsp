			...
			<div class="row mt-5">
				<div class="col ml-5">
					<div class="mb-4">
						<h1 class="text-center label-disabled"
							style="font-family: Fjalla One;">CONTATO</h1>
						<h1 class="text-center" style="font-family: Fjalla One;">CONTATO
						</h1>
					</div>
				...
				<form action="https://api.staticforms.xyz/submit" method="post">
					<input type="hidden" name="accessKey"
						value="b444f0e0-ea6c-44e8-9a9b-161b104dab03"> <input
						type="hidden" name="redirectTo"
						value=" http://localhost:8080/Conhece-Recife/contato.jsp ">
						...
						<div class="row ">
							<div class="col">
								<div class="form-group radius">
									...
									<div>
										<span class="style-error" id="errorName"
											style="display: none;">Nome errado, insira os dados de
											forma correta</span>
									</div>
								</div>
							...
							<div class="col">
								<div class="form-group radius">
									...
									<div>
										<span class="style-error" id="errorPhoneContact"
											style="display: none;">Formato de telefone errado</span>
									</div>
						...
						<div class="col">
							...
							<div class="form-group radius">
								<input type="text" name="subject" id="subject"
									class="form-control radius input-form p-2"
									placeholder="Assunto">
					...
					<div class="form-group">
						<textarea class="form-control radius input-form" name="message"
							id="message" rows="9" placeholder="Mensagem"></textarea>
						<div>
							<span class="style-error" id="errorMessageContact"
								style="display: none;"> Digite a mensagem </span>
						</div>
					</div>
					<input type="submit" class="btn btn-dark btn-block radius mt-4"
						onclick="validateFormRegisterContact(this)" value="Enviar" />
